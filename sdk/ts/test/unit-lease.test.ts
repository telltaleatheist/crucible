...
const ACTIVITY = {
  ...
  claim: null,
  streaming: null,
  chat: { in_flight: 1, max_in_flight: null, max_in_flight_basis: null, rows: [{ id: 4, act: 'translate', model: 'qwen3.8-27b-4bit', client: 'foundry', since: '2026-09-14T03:01:00+00:00' }] },
  lease: {
    lease_id: '9c1f',
    kind: 'llm',
    client: 'foundry/owens-pc crucible-client/0.5.0',
